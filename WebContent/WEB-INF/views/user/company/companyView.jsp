...
//목록으로돌아가기
	...
	$('#out').click(function(){
		...
		location.href = '${pageContext.request.contextPath }/user/company/deleteCompany.do?com_id=${LOGIN_MEMBERINFO.com_id}';
	});
	
	$('form[name=comForm]').submit(function(){
		$(this).attr('action', '${pageContext.request.contextPath }/user/company/updateCompany.do');
