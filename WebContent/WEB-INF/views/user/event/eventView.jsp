...
$(function(){
    ...
    $('#eventView').submit(function(){
    	...
    	$(this).attr('action', '${pageContext.request.contextPath}/user/event/updateEvent.do');
	...
	var flag = redirectFlag();
			if (flag) {
				location.href = '${pageContext.request.contextPath}/user/event/deleteEvent.do?event_no=${eventInfo.event_no}';
					} else {
		...
		$('#eventReplyRegist')
				.submit(
						function() {
							...
							$(this)
									.attr('action',
											'${pageContext.request.contextPath}/user/eventreply/insertEventReply.do');
							$(this)
									.append(
											'<input type="hidden" name="event_no" value="${eventInfo.event_no}"></input>');
							$(this)
									.append(
											'<input type="hidden" name="er_seq" value="0"></input>');
							$(this)
									.append(
											'<input type="hidden" name="er_depth" value="0"></input>');
							$(this)
									.append(
											'<input type="hidden" name="mem_id" value="${LOGIN_MEMBERINFO.mem_id}"></input>');
...
// 								$(location).attr(
// 										'href',
// 										'${pageContext.request.contextPath}/user/eventreply/deleteEventReply.do?er_no='
// 												+ er_no);
// 							}
// 						});
		// 	$(function() {
		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox" style="height: 200px;">
				<c:forEach items="${eventInfo.items }" var="efileitem" varStatus="stat">
						...
						onclick="javscript:location.href='${pageContext.request.contextPath }/user/event/eventFileDown.do?fileSEQ=${efileitem.efile_seq }&event_no=${efileitem.event_no}';"></div>
			</c:forEach>
...
<form id="${replyList.er_no}" method="post" action="${pageContext.request.contextPath}/user/eventreply/updateEventReply.do">
	<div class="form-group"> 
		<label class="control-label col-sm-2" >댓글:</label>
		<div class="col-sm-10">	
...
<form method="post" action="${pageContext.request.contextPath}/user/eventreply/insertEventReReply.do">
		<div class="form-group">
