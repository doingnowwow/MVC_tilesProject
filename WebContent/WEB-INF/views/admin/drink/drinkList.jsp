...
<div >
<form action="${pageContext.request.contextPath }/admin/drink/drinkList.do" method="post" class="form-inline pull-left">
...
<form action="${pageContext.request.contextPath}/admin/drink/drinkList.do" method="post" class="form-inline pull-right">
...
$(function(){
	...
	$('#registBTN').click(function(){
		if(eval('${!empty LOGIN_MEMBERINFO.com_id}')){
			$(location).attr('href', '${pageContext.request.contextPath}/admin/drink/drinkForm.do');
	...
	$('#freeListTBY tr').click(function(){
        ...
        var url = '${pageContext.request.contextPath}/admin/drink/drinkView.do';
