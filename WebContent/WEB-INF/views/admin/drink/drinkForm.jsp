...
$(function(){
   ...
   $('#drinkForm').submit(function(){
      var zip = $('input[name=drink_add]').val();
      ...
      $(this).attr('action', '${pageContext.request.contextPath}/admin/drink/insertDrink.do');
   ...
   $('#drinkListBTN').click(function(){
      location.href = '${pageContext.request.contextPath}/admin/drink/drinkList.do';
   });
...
function zipcodePopup(){
    ...
    var url = '${pageContext.request.contextPath}/admin/drink/zipcodeSearchForm.do';
