...
//     });
	...
	$('#reviewForm').submit(function(){
		$(this).attr('action', '${pageContext.request.contextPath}/admin/review/insertReview.do');
		...
		if($('#review_content').text().trim().length <= 0){
		 	BootstrapDialog.show({
		 	    title: '경고',
		 	    message: '내용을 입력해주세요.'
	 		});
	...
	$('#listBTN').click(function(){
		$(location).attr('href', '${pageContext.request.contextPath}/admin/review/reviewList.do');
	});
