...
<div >
<form action="${pageContext.request.contextPath }/admin/review/reviewList.do" method="post" class="form-inline pull-left">
...
$(function(){
	$('#registBTN').click(function(){
		 if(eval('${!empty LOGIN_MEMBERINFO}')){
			$(location).attr('href', '${pageContext.request.contextPath}/admin/review/reviewForm.do');
		}else{
			alert("로그인해주세요.");
		}
	});
	...
	$('#reviewListTBY tr').click(function(){
        ...
        var url = '${pageContext.request.contextPath}/admin/review/reviewView.do';
