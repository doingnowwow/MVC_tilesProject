...
<title>404에러페이지 | 페이지를 찾을 수 없음</title>
</script>
<style type="text/css">
...
<div id="topArea">
	<h2><a href="http://www.daum.net" title="Sunmi 첫화면으로 가기" target="_top" class="daum">404</a></h2>
</div>
...
<div class="btn_area">
	...
	<a href="http://www.daum.net" class="btn_go_home">404 첫화면</a>
</div>
