...
<body>
	...
	<div>
		<form
			action="${pageContext.request.contextPath}/admin/event/eventList.do"
	...
	$(function() {
		$('#registBTN').click(function() {
			if(eval('${!empty LOGIN_MEMBERINFO.com_id}')){
				$(location).attr('href', '${pageContext.request.contextPath}/admin/event/eventForm.do');
		...
		$('#eventListTBY tr').click(function() {
				...
				var url = '${pageContext.request.contextPath}/admin/event/eventView.do';
