...
$(function(){
    ...
    $('#drinkView').submit(function(){
    	...
    	if (flag) {
	    	$(this).attr('action', '${pageContext.request.contextPath}/admin/drink/updateDrink.do');
    ...
    $('#deleteDrinkBTN').click(function(){
    	...
    	location.href = '${pageContext.request.contextPath}/admin/drink/deleteDrink.do?drink_no='+${drinkInfo.drink_no};
