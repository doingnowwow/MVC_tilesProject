...
//     alert("${reviewInfo.review_like}");
	...
	$('#reviewListBTN').click(function(){
		location.href = '${pageContext.request.contextPath}/user/review/reviewList.do';
	});
	...
	$('#reviewView').submit(function(){
		...
		if(flag){
			...
			$(this).attr('action', '${pageContext.request.contextPath}/user/review/updateReview.do');
			return true;
		}else{
	...
	$('#deleteBTN').click(function(){
		...
		if(flag){
			$(location).attr('href', '${pageContext.request.contextPath}/user/review/deleteReview.do?review_no=${reviewInfo.review_no}');
		}else{
	...
	$('form').on('click', 'button[class=delete]', function(){
		...
		$(location).attr('href', '${pageContext.request.contextPath}/user/reviewreply/deleteReviewReply.do?rr_no='+rr_no+'&review_no='+review_no);
	});
		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox" style="height: 200px;">
				<c:forEach items="${reviewInfo.items }" var="fileitem" varStatus="stat">
					...
					onclick="javscript:location.href='${pageContext.request.contextPath }/user/review/reviewFileDown.do?fileSEQ=${fileitem.rfile_seq }&review_no=${fileitem.review_no}';">
				</div>
				</c:forEach>
			</div>
...
<form id="reviewReplyRegist" method="post" action="${pageContext.request.contextPath}/user/reviewreply/insertReviewReply.do">
	<div class="form-group"> 
...
<form id="${replyList.rr_no}" method="post" action="${pageContext.request.contextPath}/user/reviewreply/updateReviewReply.do">
		<div class="form-group"> 
...
<form id="rrrr" method="post" action="${pageContext.request.contextPath}/user/reviewreply/insertReviewReReply.do">
		<div class="form-group">
			<input type="hidden" name="rr_no" value="${replyList.rr_no}">
			<input type="hidden" name="review_no" value="${reviewInfo.review_no}">
