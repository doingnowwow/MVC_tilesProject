...
$(function(){
	...
	$('#eventForm').submit(function(){
		// 입력값 검증 - 과제
		$(this).attr('action', '${pageContext.request.contextPath}/admin/event/insertEvent.do');
...
<body>
<form id="eventForm" class="form-horizontal" role="form" action="<%=request.getContextPath()%>/admin/event/insertEventAction.do" method="post" enctype="multipart/form-data">
