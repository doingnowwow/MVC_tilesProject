...
<div id="header-topbar-option" class="page-header-topbar">
	<nav id="topbar" role="navigation" style="margin-bottom: 0;" data-step="3" 
		...
		<div class="navbar-header">
			<span class="logo-text text-yellow" style="font-size: 16px;" ><a href="/SUL/user/main.do">
				...
				<ul class="nav navbar navbar-top-links navbar-right mbn">
					<li class="dropdown">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li><a href="${pageContext.request.contextPath}/user/member/memberView.do?mem_id=${LOGIN_MEMBERINFO.mem_id}" id="profile"><i class="fa fa-user"></i>프로필관리</a></li>
							</c:if>
							<c:if test="${!empty LOGIN_MEMBERINFO.com_id }">
							<li><a href="${pageContext.request.contextPath}/user/company/companyView.do?com_id=${LOGIN_MEMBERINFO.com_id}" id="profile"><i class="fa fa-user"></i>프로필관리</a></li>
							</c:if>
							<li class="divider"></li>
							<li><a href="${pageContext.request.contextPath}/user/member/logout.do"><i class="fa fa-key"></i>로그아웃</a></li>
						</ul>
					</li>
				</ul>
			</div>
