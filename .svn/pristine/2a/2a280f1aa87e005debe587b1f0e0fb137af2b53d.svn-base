...
<script>
	$(function() {
		...
		if (flag) {
				$(location).attr('href','${pageContext.request.contextPath}/admin/qna/deleteQna.do?qna_no=${qnaInfo.qna_no}');
		...
		if(flag){
			...
			$(this).attr('action','${pageContext.request.contextPath}/admin/qna/updateQna.do');
...
$('#replyFormBTN').click(function() {
	...
	var url = '${pageContext.request.contextPath}/admin/qna/qnaReplyForm.do';
			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox" style="height: 200px;">
					<c:forEach items="${qnaInfo.items }" var="qfileitem"
						...
						onclick="javscript:location.href='${pageContext.request.contextPath }/admin/qna/qnaFileDown.do?fileSEQ=${qfileitem.qfile_seq }&qna_no=${qfileitem.qna_no}';">	</div>
