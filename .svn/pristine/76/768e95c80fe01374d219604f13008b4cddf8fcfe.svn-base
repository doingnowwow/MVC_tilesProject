...
<body>
	...
	<div class="panel panel-grey">
		...
		<div class="panel-body">
			<table class="table table-hover table-striped">
				...
				<tbody>
					...
					<c:forEach items="${companyList }" var="comInfo">
						<tr>
							<td>${comInfo.com_id }</td>
							<td>${comInfo.com_nickname }</td>
							<td>${comInfo.com_name }</td>
							<td>${comInfo.com_email }</td>
						</tr>
					</c:forEach>
		...
		<div class="searchForm" align="right" style="margin-top: 10px;">
			<form method="post"
				action="${pageContext.request.contextPath }/admin/company/companyList.do">
