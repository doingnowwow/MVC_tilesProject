...
//     	}
    	...
    	$(this).attr('action', '${pageContext.request.contextPath}/user/notice/updateNotice.do');
    ...
    $('#deleteNoticeBTN').click(function(){
		var flag = redirectFlag();
		if(flag){
    	location.href = '${pageContext.request.contextPath}/user/notice/deleteNotice.do?notice_no=${noticeInfo.notice_no}';
		}else {
 ...
 function redirectFlag(){
	...
	function redirectFlag() {
		if ('${noticeInfo.mem_id}' == '${LOGIN_MEMBERINFO.mem_id}') {
			return true;
		}else if('${noticeInfo.mem_id}' == '${LOGIN_MEMBERINFO.com_id}'){
			return true;
		}
		return false;
	}
...
<form id="noticeView" class="form-horizontal" role="form" method="post">
	...
	<div class="form-group">
		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			onclick="javscript:location.href='${pageContext.request.contextPath }/user/notice/noticeFileDown.do?fileSEQ=${nfileitem.nfile_seq }&notice_no=${nfileitem.notice_no}';"></div>
